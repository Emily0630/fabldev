...
hash_vabl <- hash_comparisons(cd, method = "vabl")
hash_fabl <- hash_comparisons(cd, method = "fabl")
hash_brl <- hash_comparisons(cd, method = "brl")
...
out <- svi_efficient(hash, B = 10, holdout_size = 100, k = 1, seed = 42)
results <- vi_estimate_links(out, hash)
evaluate_links(results$Z_hat, Ztrue, n1)
out$t
